...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Content Sections */}
      <section className="relative py-10 bg-gradient-to-br from-light-200 via-white to-light-200 overflow-hidden">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
      ...
      >
        ...
        <p className="text-gray-700 text-base lg:text-lg leading-relaxed font-poppins">
